...
def scoreboard():
    ...
    global mul_free
    global div_free
    while(clock<=98 and flag!=0):# and flag): #or instruction[n-2]['W']!=0):
       #print (clock)
       for i in range(0,n):
            #print(dest)
...
##                  
               ...
               if(op=='compare'):
                  #print ('found unit in issue')
                  if(comp['busy']==0):#or clock==inti_free):
                     #issue[i]=1
                     #fetch_flag=0
                     comp['busy']=1
                     instruction[i]['I']=clock
